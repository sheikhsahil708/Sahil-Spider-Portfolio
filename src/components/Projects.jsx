...
import imgMan from '../assets/man/1775519899126.png.png';
...
const MISSIONS = [
  {
    id: '01',
    name: 'Collage Project Competition',
    description: 'Built a seamless eCommerce platform with big features at the lowest cost.',
  ...
  {
    id: '02',
    name: 'Operation: Spider',
    description: 'A visually stunning liquid-style portfolio where design flows seamlessly, blending creativity with smooth, dynamic interactions.',
  ...
  {
    id: '03',
    name: 'Project BioData',
    description: ' Built a sleek, modern marriage biodata platform with multiple creative options to personalize every profile.',
    tech: ['React', 'Next.js', 'Shadcn UI', 'AWS'],
    image: imgSpiderman,
    link: '#',
