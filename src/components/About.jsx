      ...
      <div className="max-w-[90rem] w-full grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center relative z-10">
        ...
        <div ref={textContainerRef} className="flex flex-col justify-center space-y-10">
          ...
          <div className="overflow-hidden">
            ...
            Behind every stunning digital experience lies a hidden engine—
lines of logic, data, and performance working tirelessly in the backend.
But what users feel… is the frontend.
I specialize in blending both worlds—
hiding complexity behind elegance,
and turning powerful systems into experiences people love to use.
            </p>
          </div>
          ...
          <div className="overflow-hidden mt-6">
            <blockquote className="stagger-reveal border-l-2 border-red-500/50 pl-6 py-2">
              <p className="text-xl md:text-2xl text-gray-200 font-serif italic">
                “Logic creates structure. <br /> Imagination creates impact.”
              </p>
            </blockquote>
          </div>
